...
function Header() {
  return (
    <div className="min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden bg-image" style={{backgroundImage:"url('header_img.png')",}} id="header">
      <Navbar/>
      <motion.div
